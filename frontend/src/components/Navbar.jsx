      ...
      <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <Link href="/" className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span className="ml-3 text-xl">Scalenow</span>
          </Link>
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            {isAuth ? (
              <>
                <Link href="/user/profile" className="mr-5 hover:text-gray-900">Profile</Link>
                <Link href="/user/change-password" className="mr-5 hover:text-gray-900">Change Password</Link>
            ...
            <Link href="/user/blog" className="mr-5 hover:text-gray-900">Blogs</Link>
              ...
              <>
                <Link href="/account/login" className="mr-5 hover:text-gray-900">Login</Link>
                <Link href="/account/register" className="mr-5 hover:text-gray-900">Register</Link>
                <Link href="/user/product" className="mr-5 hover:text-gray-900">Products</Link>
            <Link href="/user/blog" className="mr-5 hover:text-gray-900">Blogs</Link>
              </>
            )}
